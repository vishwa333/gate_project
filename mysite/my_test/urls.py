...
urlpatterns = [
    ...
    path('tests_v2',views.tests_v2,name='tests'),
    ...
    path('get_initial_topic_wise',views.get_initial_topic_wise,name='get_initial_topic_wise'),
    path('view_result',views.view_result,name='view_result'),
    path('get_subjects_list',views.get_subjects_list,name='view_result'),
